...
/**
 * DTO para transporte de dados de Servico,
 * incluindo informações de moderação e relacionamento.
 */
public class ServicoDTO {
    ...
    public boolean isNecessitaAgendamento() { return necessitaAgendamento; }
